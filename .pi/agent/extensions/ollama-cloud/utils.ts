/**
 * Shared helpers for the ollama-cloud provider extension. Trimmed from the
 * upstream pi-ollama-cloud package: only what models.ts and usage.ts need.
 */
...
/**
 * Resolve the Ollama Cloud API key for a command. Prefers the canonical
 ...
 * distinct status codes. Shared by the usage command.
 */
